...
exports.formatImprovementSuggestions = formatImprovementSuggestions;
const groq_sdk_1 = __importDefault(require("groq-sdk"));
const groq = new groq_sdk_1.default({ apiKey: process.env.GROQ_API_KEY });
async function generateImprovementSuggestions(jd, cvText, gaps) {
...
Return ONLY valid JSON (no markdown, no backticks):
{
  ...
  "summary": "Overall strategy in 2 sentences"
    ...
    if (!jsonMatch)
        throw new Error('No JSON in improvement suggestions');
