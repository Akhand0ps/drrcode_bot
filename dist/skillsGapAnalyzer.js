...
exports.analyzeSkillsGap = analyzeSkillsGap;
exports.formatSkillsGapReport = formatSkillsGapReport;
const groq_sdk_1 = __importDefault(require("groq-sdk"));
const groq = new groq_sdk_1.default({ apiKey: process.env.GROQ_API_KEY });
async function analyzeSkillsGap(jd, cvText, missingKeywords) {
...
function formatSkillsGapReport(analysis) {
    const formatGaps = (gaps, title, emoji) => {
        if (gaps.length === 0)
            return '';
